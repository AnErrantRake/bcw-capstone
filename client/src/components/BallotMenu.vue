  ...
  <div class="ballot-menu">
    ...
    <div class="border mt-3">
      ...
      <div class="row m-2" v-for="ballot in ballots">
        <div
          :to="{name: 'ballot', params:{ballotID: ballot._id}}"
          class="col-5 col-sm-8 col-md-9 col-lg-10 text-primary"
        ...
        <div class="col">
          ...
          >Batter</button>
          <button
            @click="deleteBallot(ballot._id)"
            class="btn btn-danger btn-sm"
            type="submit"
            v-if="checkSafeDelete(ballot._id)"
          >
...
export default {
  ...
  methods: {
    ...
    checkSafeDelete(id) {
      return (
        this.$store.state.electionStore.elections.length > 0 &&
        !this.$store.state.electionStore.elections.findIndex(
          el => el.ballotID == id
        )
      );
    }
